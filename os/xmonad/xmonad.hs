...
--
myNormalBorderColor = myNormColor
myFocusedBorderColor = myFocusColor
...
myStartupHook = do
  ...
  spawnOnce "xmodmap -e 'keysym Caps_Lock = Escape'"
...
main = do
  ...
  xmproc2 <- spawnPipe "xmobar -x 2 ~/.config/xmobar/xmobar.hs"
