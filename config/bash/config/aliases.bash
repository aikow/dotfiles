...
alias jk='jj status'
alias jl='jj log'
alias jlc='jj log --template=builtin_log_compact_full_description'
alias jld='jj log --template=builtin_log_detailed'
alias jlo='jj log --template=builtin_log_oneline'
